...
if (room == room_ocean) {
    ...
    draw_set_colour(make_colour_rgb(255, 80, 20));
    draw_text(10, 10, "SURFACE — DANGER ZONE");
}
...
draw_text(pad + 8, by + 6,  "Iron:     " + string(obj_resource_manager.iron));
draw_set_colour(make_colour_rgb(100, 200, 255));
draw_text(pad + 8, by + 26, "Crystal:  " + string(obj_resource_manager.crystal));
draw_set_colour(make_colour_rgb(180, 100, 255));
draw_text(pad + 8, by + 46, "Obsidian: " + string(obj_resource_manager.obsidian));
